    ...
    function changeColor() {
        ...
        document.getElementsByClassName('btn-color')[0].classList.toggle('btn-color-change');
        document.getElementsByClassName('btn-color')[1].classList.toggle('btn-color-change');
        document.getElementsByClassName('btn-color')[2].classList.toggle('btn-color-change');
        document.getElementsByClassName('btn-color')[3].classList.toggle('btn-color-change');
